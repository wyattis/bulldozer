...
var holdDelay = 70;
var levelPassword = {4:"BONK", 8:"NERD", 12:"BURP", 16:"SPUD", 20:"GROK", 24:"SPOT", 28:"KALE", 32:"PODS", 36:"TAPS", 40:"KRIL", 44:"GNIP", 48:"GORN", 52:"LOUT"};
...
//========================================End Game Class=============================================
    ...
    var Map = {
        ...
        LoadImages: function(){
          ...
          Map.spiral.src = "static/images/Sprites/Spiral.png";
          Map.plus.src = "static/images/Sprites/Plus.png";
          Map.square.src = "static/images/Sprites/Square.png";
        },
    ...
    function Bulldozer() {
      ...
      this.dozer.src = "static/images/Sprites/Bulldozer.png";
    }
...
function NotificationAppear(text){
  ...
  if(Map.level+1 in levelPassword){
    notificationModal.innerHTML="<div id='notif-head'><h2 id='tittle'>Level  " + Map.level + "</h2></div><p> Success! <br> Password: "+levelPassword[Map.level+1] + " </p><button id='notif-close-button'>Continue</button>";
  }
  else{
    notificationModal.innerHTML="<div id='notif-head'><h2 id='tittle'> Level  " + Map.level + "</h2></div><p> Success! </p><button id='notif-close-button'>Continue</button>";
  }
